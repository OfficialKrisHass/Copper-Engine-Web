    ...
    return (
        <>
            ...
            <p>We believe that games are an art-form, and like any other art-form, throwing millions of dollars into it, and bringing on massive teams, do not
               ...
               taking time and dedication. Good things are Hard to make</p>
            <br/>
            <p>What we mean by that is that just because an the engine used to make a game has astounding graphics, or the studio behind it is a AAA multi billion
            ...
            <p>However at the moment, due to the new, uncharted nature of the engine, the best demographic are experimentative developers, who don't mind working with
               minimal tutorials and documentation, possibly helping create said tutorials or documentation. People who have some experience with game engine programming
               or are looking to gain some.</p>
        </>
    );
